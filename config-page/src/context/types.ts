...
export interface Settings {
  ...
  SETTING_WORK_SCHEDULE_ENABLED: number;
  SETTING_WORK_START: number;
  SETTING_WORK_END: number;
  SETTING_WORK_DAYS: number;
  SETTING_HOLIDAY_MODE: number;
  SETTING_WORK_WIDGET_UPPER_SECONDARY: string;
  SETTING_WORK_WIDGET_UPPER_PRIMARY: string;
  SETTING_WORK_WIDGET_LOWER_PRIMARY: string;
  SETTING_WORK_WIDGET_LOWER_SECONDARY: string;
}
